...
table(pred_svm_extra_ma_liwc, test_data$extraversion_m)
...
table(pred_svm_extra_ma_social, test_data$extraversion_m)
...
table(pred_svm_extra_ma_gram, test_data$extraversion_m)
...
table(pred_svm_agrea_ma_liwc, test_data$agreeabeness_m)
...
table(pred_svm_agrea_ma_social, test_data$agreeabeness_m)
...
table(pred_svm_cons_ma_liwc, test_data$conscientiousness_m)
...
table(pred_svm_cons_ma_social, test_data$conscientiousness_m)
...
table(pred_svm_neu_ma_liwc, test_data$neuroticism_m)
...
table(pred_svm_neu_ma_social, test_data$neuroticismsm_m)
...
table(pred_svm_open_ma_liwc, test_data$openness_m)
...
table(pred_svm_open_ma_social, test_data$openness_m)
