...
tb_svm_extra_ma_liwc <- table(pred_svm_extra_ma_liwc, test_data$extraversion_m)
...
tb_svm_extra_ma_social <- table(pred_svm_extra_ma_social, test_data$extraversion_m)
...
tb_svm_extra_ma_gram <- table(pred_svm_extra_ma_gram, test_data$extraversion_m)
...
tb_svm_agrea_ma_liwc <- table(pred_svm_agrea_ma_liwc, test_data$agreeabeness_m)
...
tb_svm_agrea_ma_social <- table(pred_svm_agrea_ma_social, test_data$agreeabeness_m)
...
tb_svm_agrea_ma_gram <- table(pred_svm_agrea_ma_gram, test_data$agreeabeness_m)
...
tb_svm_cons_ma_liwc <- table(pred_svm_cons_ma_liwc, test_data$conscientiousness_m)
...
tb_svm_cons_ma_social <- table(pred_svm_cons_ma_social, test_data$conscientiousness_m)
...
tb_svm_gram_ma_gram <- table(pred_svm_gram_ma_gram, test_data$conscientiousness_m)
...
tb_svm_neu_ma_liwc <-  table(pred_svm_neu_ma_liwc, test_data$neuroticism_m)
...
tb_svm_neu_ma_social <- table(pred_svm_neu_ma_social, test_data$neuroticismsm_m)
...
tb_svm_neu_ma_gram <- table(pred_svm_neu_ma_gram, test_data$neuroticism_m)
...
tb_svm_open_ma_liwc <- table(pred_svm_open_ma_liwc, test_data$openness_m)
...
tb_svm_open_ma_social <- table(pred_svm_open_ma_social, test_data$openness_m)
...
tb_svm_open_ma_gram <- table(pred_svm_open_ma_gram, test_data$openness_m)
